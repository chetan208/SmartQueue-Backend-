...
import {
  ...
  setPassword,
  branding,
} from "../controllers/hospitalRegistrationController.js";

import {
  addDepartment,
  uploadImage,
} from "../controllers/departmentRegistrationController.js";
...
router.get("/department-details/:departmentId", getSingleDepartmentDetail);
